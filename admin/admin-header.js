(function(){
  ...
  ['/admin/admin-utils.js','/admin/admin-session.js','/admin/admin-tabs.js','/admin/admin-navigation.js','/admin/admin-theme.js','/admin/admin-media.js','/admin/admin-comments.js','/admin/admin-site-content.js','/admin/admin-services.js','/admin/admin-homepage-links.js','/admin/admin-classes.js','/admin/admin-gallery.js','/admin/admin-live.js','/admin/admin-bridge.js'].forEach(src=>{const script=document.createElement('script');script.src=src;script.defer=true;document.head.appendChild(script);});
})();
