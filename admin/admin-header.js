(function(){
  ...
  ['/admin/admin-navigation.js','/admin/admin-theme.js','/admin/admin-media.js'].forEach(src=>{const script=document.createElement('script');script.src=src;script.defer=true;document.head.appendChild(script);});
})();
