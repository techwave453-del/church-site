(function(){
  ...
  const load=()=>{const loader=document.createElement('script');loader.src='/admin/admin-loader.js';loader.onload=function(){if(window.loadAdminModules)window.loadAdminModules().catch(e=>console.error(e));};loader.onerror=function(){console.error('Failed to load admin module loader.');};document.head.appendChild(loader)};
