(function(){
  ...
  if(!document.querySelector('link[data-admin-header-icons-css]')){const link=document.createElement('link');link.rel='stylesheet';link.href='/admin/admin-header-icons.css?v='+encodeURIComponent(window.__ADMIN_BUILD_VERSION);link.dataset.adminHeaderIconsCss='true';document.head.appendChild(link)}
  mount.innerHTML='<header class="admin-header"><div class="admin-header__brand"><img class="admin-header__logo" data-admin-header-logo alt="Church logo"><div class="admin-header__brand-text"><strong class="admin-header__church-name" data-admin-header-name>Kingdom Fellowship Christian Church</strong><span class="admin-header__admin-label">Admin</span></div></div><div class="admin-header__actions"><span id="apiStatus" class="admin-header__status" title="API status"><span class="admin-header__status-text">Checking…</span></span><button id="adminPwaInstall" class="admin-header__icon-button admin-pwa-install admin-header__tooltip" type="button" aria-label="Install Admin App" title="Install Admin App"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3v12"></path><path d="m7 10 5 5 5-5"></path><path d="M5 21h14"></path></svg></button><button id="adminLogout" class="admin-header__icon-button admin-header__tooltip admin-header__logout" type="button" onclick="logout()" aria-label="Log out" title="Log out" hidden><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M10 17l5-5-5-5"></path><path d="M15 12H3"></path><path d="M14 4h5a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-5"></path></svg></button></div></header>';
