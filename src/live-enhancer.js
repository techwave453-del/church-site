...
(function(){
  ...
  const mount=()=>{
    ...
    if(!button){
      button=document.createElement('button');button.id='live-enhancer-button';button.type='button';button.setAttribute('aria-label','Open live worship service');button.innerHTML='<span>LIVE</span>';document.body.appendChild(button);
    }
